...
**1.** Fork [this](https://github.com/ronisarkarexe/First-Issue.git) repository.

**2.** Clone your forked copy of the project.

```
git clone https://github.com/<your_user_name>/First-Issue.git
```
...
```
git remote add upstream https://github.com/ronisarkarexe/First-Issue.git
```
